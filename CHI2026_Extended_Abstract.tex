...
\title{GestureFlow: EMG-GSR Gesture Recognition for Rhythm Management in Digital Nomads}
...
\begin{abstract}
Digital nomads represent a rapidly growing workforce of 35 million professionals who work remotely while maintaining location-independent lifestyles. Despite their freedom, this group faces significant challenges in managing focus, work-life boundaries, and sustainable productivity rhythms. Traditional wellness tools fail to capture the embodied nature of work-related stress and fatigue. This research introduces GestureFlow, a novel EMG-GSR gesture recognition system that reads natural hand movements to help digital nomads understand and regulate their work-life rhythms.

Our system combines EMG (8-channel) and GSR sensors to detect subtle hand gestures and physiological states (rest, work, leisure) with sub-100ms latency using CoreML-optimized models. Rather than measuring abstract physiological signals, GestureFlow recognizes embodied hand movements -- such as coffee cup handling, keyboard tension, or relaxed grip -- that naturally occur throughout the day and reflect underlying cognitive and emotional states. When fatigue or distraction patterns are detected, the system provides gentle rhythm-guiding interventions through a seamlessly integrated iOS application.

Through a 4-week study with 15 digital nomads, GestureFlow demonstrated a 25\% increase in focused work duration, a 20\% reduction in self-reported stress levels, and an 89\% accuracy in detecting three core rhythmic states with a 2-minute personalization protocol. The system represents a significant advancement in embodied computing by creating a technology that reads the body's natural language rather than controlling it.

Our contributions include: (1) the first gesture recognition system designed specifically for digital nomad rhythm management, (2) a novel EMG-GSR fusion approach that captures embodied hand movements, (3) a privacy-first embodied interaction framework that senses rather than controls, and (4) empirical evidence of the effectiveness of gesture-based rhythm management in remote work contexts.
\end{abstract}
...
\keywords{Gesture Recognition, Embodied Computing, Digital Nomads, Physiological Computing, EMG, GSR, Rhythm Management}
